...
switch fopts.contourType
    ...
    otherwise
        faceColor = 'interp';
        faceAlpha = fopts.def2DFaceAlphaContour;
end
...
if nargin < 5
    ...
    % Don't recreate surfs, this saves a lot of time
    set(ph,'XData',[p(1,1:2);p(1,4:-1:3)]);
    set(ph,'YData',[p(2,1:2);p(2,4:-1:3)]);
    set(ph,'ZData',[p(3,1:2);p(3,4:-1:3)]);
    set(ph,'CData',[contourValues(1:2);contourValues(4:-1:3)])
    set(ph,'FaceColor',faceColor);
    set(ph,'FaceAlpha',faceAlpha);
end
